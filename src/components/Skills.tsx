...
function SkillCard({ cat, index }: { cat: (typeof skillCategories)[number]; index: number }) {
  ...
  return (
    <motion.div
      ...
      onMouseMove={onMove}
      data-hover
      className="card-sheen group relative h-full rounded-2xl border border-white/[0.08] bg-gradient-to-b from-white/[0.04] to-white/[0.01] p-6 sm:p-7 transition-all duration-400 hover:-translate-y-2 hover:border-accent/40 hover:shadow-[0_30px_70px_-25px_rgba(255,106,43,0.45)]"
    >
  ...
  return (
    <section id="skills" className="relative py-24 md:py-32 scroll-mt-24">
      ...
      <div className="relative mx-auto max-w-7xl px-5 sm:px-8">
        ...
        <div className="mt-5 flex flex-col md:flex-row md:items-end md:justify-between gap-4 mb-14">
          <Reveal delay={0.08}>
